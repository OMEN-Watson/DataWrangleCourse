...
# Updated by Anushka Vidanage, August 2023
# Updated by Charini Nanayakkara, August 2024
#
# Usage:
#
...
student_data_set_name = 'data_wrangling_education_2024_%s.csv' % (anu_id)
...
print('-'*40)
print()
print('Your student data set for the second data wrangling 2024 assignment')
