...
# Updated by Charini Nanayakkara, Jul 2024
#
# Usage:
#
...
student_data_set_name = 'data_wrangling_medical_2024_%s.csv' % (anu_id)
...
print('-'*40)
print()
print('Your student data set for the data wrangling 2024 assignments')
